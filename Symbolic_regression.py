...
est_gp = SymbolicRegressor(population_size=5000,
                           ...
                           #0.05, The probability of performing hoist mutation on a tournament winner.
                           # Hoist mutation takes the winner of a tournament and selects a random subtree from it.
                           # A random subtree of that subtree is then selected and this is ‘hoisted’ into the original subtrees location
                           # to form an offspring in the next generation. This method helps to control bloat.
